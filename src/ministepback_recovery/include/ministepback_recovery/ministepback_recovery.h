...
namespace ministepback_recovery{
  ...
  class MiniStepBackRecovery : public nav_core::RecoveryBehavior {
    public:
       ...
       * @return 
       */
      MiniStepBackRecovery();

      /**
       * @brief  Initialization function for the MiniStepBackRecovery recovery behavior
      ...
      /**
       * @brief  Run the MiniStepBackRecovery recovery behavior.
       */
      void runBehavior();
    ...
    private:
      ...
      double stepback_speed_, stepback_time_;
