...
# Variabili binarie rilassate tra 0 e 1
var scelta_guardie {Guardie} >= 0, <= 1; # scelta_guardie[g] = 1 se scelgo la guardia g, 0 altrimenti
var scelta_guardie_coppie {Guardie, Guardie} >= 0, <= 1; # variabile ausiliaria per linearizzare il prodotto "scelta_guardie[g1] * scelta_guardie[g2]" (vedi https://or.stackexchange.com/questions/37/how-to-linearize-the-product-of-two-binary-variables)
var coperto {Witnesses} >= 0, <= 1; # coperto[w] = 1 se copro il testimone w, 0 altrimenti
