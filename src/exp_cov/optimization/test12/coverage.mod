...
s.t. Costo_assegnamento:
    z = coeff_coverage * (sum {g in Guardie} costi_guardie[g] * scelta_guardie[g]) + coeff_distanze * (sum {g1 in Guardie, g2 in Guardie} scelta_guardie[g1] * scelta_guardie[g2] * distanza[g1, g2]);
