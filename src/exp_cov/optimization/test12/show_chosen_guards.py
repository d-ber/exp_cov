...
def main():
    ...
    img_path = "/home/d-ber/catkin_ws/src/exp_cov/optimization/test12/tri.png"
    img = cv2.imread(img_path)

    image_width_small = img.shape[1]
    image_height_small = img.shape[0]

    data_file_path = "/home/d-ber/catkin_ws/src/exp_cov/optimization/test12/data.dat"
    chosen_guards_file_path = "/home/d-ber/catkin_ws/src/exp_cov/optimization/test12/guardie_scelte.txt"
    posizioni_guardie = []
